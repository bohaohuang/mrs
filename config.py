...
class Args:
    def __init__(self):
        ...
        if self.ds_name == 'inria':
            self.num_classes = 2
            self.data_dir = r'/hdd/mrs/inria/ps512_pd0_ol0/patches'
            self.train_file = r'/hdd/mrs/inria/ps512_pd0_ol0/file_list_train.txt'
            self.valid_file = r'/hdd/mrs/inria/ps512_pd0_ol0/file_list_valid.txt'
        else:
