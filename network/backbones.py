"""
This file defines backbones as feature extractors
code comes from: https://github.com/Lextal/pspnet-pytorch/blob/master/extractors.py
"""
...
def load_weights_sequential(target, source_state):
    network_utils.flex_load(target.state_dict(), source_state, True)
