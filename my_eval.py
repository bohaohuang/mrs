...
# Settings
GPU = 6
MODEL_DIR = r'/home/wh145/models/ecresnet34_dcunet_dsmnih_lre1e-03_lrd1e-02_ep1_bs10_ds50_dr0p1/'
LOAD_EPOCH = 80
...
def main():
    ...
    save_dir = os.path.join(r'/home/wh145/results/mrs/mnih', os.path.basename(network_utils.unique_model_name(args)))
